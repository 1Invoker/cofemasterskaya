...
const questionsData = [
  ...
  },
  {
    ...
    answer: "Мы предоставляем гарантию на все виды работ и оригинальные комплектующие, которые используем в ремонте. Срок гарантии зависит от вида неисправности: так, например, на замену дисплея гарантия до 24 месяцев, на ремонт силовой платы - до 6 месяцев, на ремонт гидросистемы - до 6 месяцев. В гарантийном талоне укажем всё подробно, или уточните у менеджера срок гарантии на неисправность, выявленную у вашей поломоечной машины."
  },
  {
