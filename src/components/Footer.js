  ...
  return (
    <FooterWrapper>
      ...
      <FooterSection>
        ...
        <FooterList>
          <FooterListItem>
            <PaymentImage src={maestroCard} alt="MasterCard" />
          </FooterListItem>
          <FooterListItem>
            <PaymentImage src={maestro} alt="Maestro" />
          </FooterListItem>
          <FooterListItem>
          ...
          <FooterListItem>
            <PaymentImage src={visaQiwi} alt="Visa Qiwi Wallet" />
          </FooterListItem>
          <FooterListItem>
            <PaymentImage src={mir} alt="Мир" />
          </FooterListItem>
          <FooterListItem>
        ...
        <FooterList>
          <FooterListItem>
            <BankImage src={sberbank} alt="Сбербанк" />
          </FooterListItem>
          <FooterListItem>
            <BankImage src={alfaBank} alt="Альфа банк" />
          </FooterListItem>
          <FooterListItem>
            <BankImage src={raifizen} alt="Райффайзен" />
          </FooterListItem>
          <FooterListItem>
            <BankImage src={vtb24} alt="ВТБ24" />
          </FooterListItem>
        </FooterList>
      </FooterSection>
