...
const Home = () => {
  ...
  const { cityName, districtName, brandName, typeName, issueSlug } = useParams(); // Получаем issueSlug
  ...
  }, [cityName, districtName, brandName, typeName, selectedServiceSlug, issueSlug]);
